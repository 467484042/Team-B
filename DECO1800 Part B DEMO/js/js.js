...
function iterateRecords(data) {
	...
	$.each(data.result.records, function(recordKey, recordValue) {
		...
		if (recordTitle && recordImage.endsWith(".jpg") && recordDescription) {
			$("#boardImg").append(
				$('<div class="mySlides">').append($("<img>").attr("src", recordImage))
			);
			$(".popboard").append(
...
$(document).ready(function() {
	...
	$("#drawing-board a, #drawing-board-popup .close-button a").click(function(
		event
	) {
	...
	$("#previous-drwaing a, #prvious-board-popup .close-button a").click(function(
		event
	) {
